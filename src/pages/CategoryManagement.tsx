          ...
          <div className="p-3 border-b border-slate-100">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-white text-slate-900 text-sm border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-200 focus:border-[#14b84b]"
                autoFocus
              />
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="px-6 py-4 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-2.5 bg-white text-slate-700 rounded-lg border ${nameError ? 'border-red-300' : 'border-slate-200'} focus:ring-2 focus:ring-green-200 focus:border-[#14b84b] outline-none transition-all text-sm`}
              autoFocus
            />
          ...
          <div>
            ...
            <input
              ...
              className="w-24 px-4 py-2.5 bg-white text-slate-700 rounded-lg border border-slate-200 focus:ring-2 focus:ring-green-200 focus:border-[#14b84b] outline-none transition-all text-sm text-center"
            />
          </div>
